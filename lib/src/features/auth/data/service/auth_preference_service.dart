...
class AuthPreferenceService {
  ...
  static MedusaApiVersion get medusaApiVersionGetter =>
      instance._authPreference.medusaApiVersion;
    ...
    try {
      switch (_authPreference.authType) {
        ...
        case AuthenticationType.supabase:
          return await _securePrefs.containsKey(key: AppConstants.supabaseTokenKey);
      }
    } catch (_) {
      return false;
    }
