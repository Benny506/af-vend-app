...
import 'package:medusa_admin/src/core/extensions/locale_extension.dart';
                                      ...
                                      children: [
                                        ...
                                        TextButton(
                                          style: TextButton.styleFrom(
                                            ...
                                            onPressed: () {
                                              context.pushRoute(const SignupWizardRoute());
                                            },
                                          child: const Text(
                                            'Register',
                                            style: TextStyle(
  ...
  Future<void> _signIn() async {
    switch (AuthPreferenceService.authTypeGetter) {
      ...
      case AuthenticationType.supabase:
        context
            .read<AuthenticationBloc>()
            .add(AuthenticationEvent.logInSupabase(emailCtrl.text, passwordCtrl.text));
        break;
    }
